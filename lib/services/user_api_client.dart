...
class UserApiClient {
  ...
  Future<Auth> login({required String email,required String password}) async {
    ...
    // var loginResponse = await http.Response.fromStream(response);
    ...
    print("code  :${loginJson}");
    return Auth.fromJson(loginJson);
  }


  Future<void> logout(String token) async {
    final logoutUrl = '$baseUrl/auth/petrol';
  ...
  Future<User> fetchAuthInfo() async {
    final url = '$baseUrl/user/profile';//profile';
    ...
    final userJson = jsonDecode(response.body)['result'];
  ...
  Future<User> fetchUserInfo(String username) async {
    final url = '$baseUrl/user/profile';//profiles/$username';
  ...
  Future<User> editProfile(
    ...
    final url = '$baseUrl/user/profile';//profiles/$authUsername';
 ...
 //*************  UpdateEmail   */
  ...
  Future<User> updateEmail({required String password, required String email}) async {
...
//******** Upload Image */
  ...
  Future<void> uploadImages({required File avatar, required File banner}) async {
    final token = Prefer.prefs!.getString('token');
